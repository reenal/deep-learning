...
class News(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            #url = "http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=" + \self.configuration['NEWS_API']
            url = "http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=00a01d43341c4fa7b4069554834f97aa"
            res = requests.get(url)
            jsonRes = res.json()
